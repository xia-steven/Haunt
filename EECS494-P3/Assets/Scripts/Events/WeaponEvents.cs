...
class ScreenShakeEvent
{
    ...
    public ScreenShakeEvent(float amplitude_in = 0.1f) { amplitude = amplitude_in; }
...
class ScreenShakeToggleEvent
{
    ...
    public override string ToString()
    {
        return "Screen Shake Toggle Event Requested with an amplitude of " + amplitude + " and a frequency of " + shakeFrequency + ".";
    }
}
