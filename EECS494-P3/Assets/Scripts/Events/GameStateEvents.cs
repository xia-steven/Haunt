...
public class MessageEvent
{
    ...
    public MessageEvent(List<string> messages_in, int senderInstanceID_in, bool pauseTime_in, string senderName_in, KeyCode keyToWaitFor_in = KeyCode.Mouse0,
